# Docker 種別 (Version 3 以前)

!!! warning "凍結ページ — Version 3 以前専用"
    このページは **BayServer Version 3 以前** の Docker 仕様をまとめたものです。**今後の編集は行いません**。Version 4 以降のリファレンスは [Docker 種別 (Version 4 以降)](docker-types.md) を参照してください (= 現在整備中)。
